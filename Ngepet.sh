clear
 ...
 echo $pur"    (/ /    \ \)"
 echo $pur"     WW\----/WW"
 echo $pur" Author : Arel FT Allesa"
 echo -n $cy"Masukkan Nama Daerah Ngepet Kalian : "
 read Daerah
 echo -n $cy"Masukkan Jumlah Target Uang : "
 read uang
 echo
 echo -n $cy"Masukkan No Dana Anda : "
 read nodana
 echo -n $cy"Masukkan Nama Dana Anda : "
 read nama
 echo
 clear
 echo "load.." | lolcat
 ...
 echo "Telah sukses di Transfer ke Nomer Dana Anda, Silakan Di Cek Kembali" | lolcat